...
SWITCHES = [
    ...
    {"key": "end_turn", "flag": "--end-turn", "label": "结束回合",
     "hint": "出完牌点『结束回合』"},
    #  ★ 2026-09-21 用户要求改口径:干跑**是调试用的,平时不需要开**
    #    (原来写的是"第一次开面板建议先开它" —— 那会让人以为跑之前都该勾上,
    #     结果真打的时候忘了关,看起来就像"引擎不动")。
    {"key": "dry_run", "flag": "--dry-run", "label": "只看不动(调试用)",
     "hint": "调试用:只记决策、不点鼠标。平时不需要开 —— 要真打就得关掉它"},
]
